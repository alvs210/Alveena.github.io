...
# Load image
try:
    map_image = pygame.image.load('Ludo.jpeg')  # Ensure the image is in the same directory
...
# Define grid size and token size
grid_size = 40
token_radius = grid_size // 3

# Define starting positions and paths for tokens
...
blue_path = [ 
    (12,8), #Starting, blue
    (11,8), (10,8), (9,8), (8,8),   #Rest of #Bottom, blue
    (8,9), (8,10), (8,11), (8,12), (8,13), (8,14),  #Right, red
    (7,14), (6,14), #Right to left, red
    (6,13), (6,12), (6,11), (6,10), (6,9), (6,8),  #Left, red
    (5,8), (4,8), (3,8), (2,8), (1,8), (0,8), #Bottom, green
...
red_path = [ 
    (6,12), #Starting position, red
    (6,11), (6,10), (6,9), (6,8),  #Rest of #Left, red
    (5,8), (4,8), (3,8), (2,8), (1,8), (0,8), #Bottom, green
    (0,7), (0,6),   #Bottom to top, green
    (0,6), (1,6), (2,6), (3,6), (4,6), (5,6), (6,6), #Top, green
    (6,5), (6,4), (6,3), (6,2), (6,1), (6,0),  #Left, yellow
...
green_path = [
    (1,6), #Green start position
    (2,6), (3,6), (4,6), (5,6), (6,6), #Top, green
    (6,5), (6,4), (6,3), (6,2), (6,1), (6,0),  #Left, yellow
    (7,0),  #Before home run, yellow
    (8,0),  #Connecting yellow right and left
    (8,1), #Starting, yellow
...
# Initialize tokens at their starting positions
...
button_rect = pygame.Rect((screen_width // 2 - button_width // 2, screen_height - button_height - 20), (button_width, button_height))

# Define the order of turns
...
def draw_board_with_tokens(dice_roll=None, win=False):
    ...
    # Display the dice roll if available
    if dice_roll is not None and not win:
        dice_text = font.render(str(dice_roll), True, BLACK)
        screen.blit(dice_text, (screen_width // 2 - dice_text.get_width() // 2, screen_height // 2 - dice_text.get_height() // 2))
...
def move_token_from_start(tokens, path, start_positions, dice_roll, selected_token):
        ...
        if tokens[selected_token] in start_positions:
            new_position = path[0]
            if new_position not in tokens:  # Prevent stacking on the same position
                tokens[selected_token] = new_position
